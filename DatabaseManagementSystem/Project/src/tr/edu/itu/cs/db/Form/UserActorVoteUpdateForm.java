...
public class UserActorVoteUpdateForm extends Form {
    WicketApplication app = (WicketApplication) this.getApplication();
    private UserActorVote selectedUserActorVote = new UserActorVote();
    ...
    public UserActorVoteUpdateForm(String id) {
        super(id);
        ...
        IUserActorVoteCollection collection3 = app.getUserActorVoteCollection();
        List<UserActorVote> userActorVote = collection3.getUserActorVote();

        ChoiceRenderer userActorVoteRenderer = new ChoiceRenderer("id");
        selectbox3 = new DropDownChoice<UserActorVote>(
                "user_actor_vote_list",
                new PropertyModel<UserActorVote>(this, "selectedUserActorVote"),
                userActorVote, userActorVoteRenderer);
        this.add(selectbox3);
    ...
    public void onSubmit() {
        ...
        userActorVote.setId(selectedUserActorVote.getId());
        ...
        if (voteText.isValid() && voteText.getModelObject() <= 5
            ...
            collection.updateUserActorVote(userActorVote);
